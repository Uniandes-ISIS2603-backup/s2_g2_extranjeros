(function (ng){
    ...
    mod.controller('lugarDeInteresDeleteCtrl', ['$scope', '$http', 'lugaresDeInteresContext', '$state',
        /**
         * @ngdoc controller
         ...
         */
        function ($scope, $http, lugaresDeInteresContext, $state){
             ...
             */
            $scope.deleteLugarDeInteres=function(){
                $http.delete(lugaresDeInteresContext+'/'+idLugarDeInteres,{}).then(function(response){
